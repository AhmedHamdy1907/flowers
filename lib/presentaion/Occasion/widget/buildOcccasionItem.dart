...
class BuildOcccasionItem extends StatelessWidget {
  String nameProduct;
  String price;
  String priceBeforeDiscount;
  String discountRate;
  BuildOcccasionItem({super.key,required this.price,required this.discountRate,required this.nameProduct ,required this.priceBeforeDiscount});
  @override
